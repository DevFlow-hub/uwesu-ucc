...
return ( <Dialog open={open} onOpenChange={onClose}> <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto"> <DialogHeader> <DialogTitle>Edit Executive Profile</DialogTitle> <DialogDescription>Update executive information and profile details</DialogDescription> </DialogHeader>

```
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="flex items-center gap-4">
        <Avatar className="h-24 w-24">
          <AvatarImage src={executive.avatar_url || undefined} alt={executive.full_name || "Avatar"} />
