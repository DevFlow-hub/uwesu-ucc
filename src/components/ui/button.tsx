  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "3d": "bg-primary text-primary-foreground shadow-3d hover:shadow-3d-hover active:translate-y-1 hover:translate-y-0.5",
        "3d-secondary": "bg-secondary text-secondary-foreground shadow-3d-secondary hover:shadow-3d-secondary-hover active:translate-y-1 hover:translate-y-0.5",
        "3d-destructive": "bg-destructive text-destructive-foreground shadow-3d-destructive hover:shadow-3d-destructive-hover active:translate-y-1 hover:translate-y-0.5",
      },
      size: {
